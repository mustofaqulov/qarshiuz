...
export function CategoryCardPage() {
  const [showTimeModal, setShowTimeModal] =
    useState(false);
  useEffect(() => {
    document.body.style.overflowY = showTimeModal
      ? 'hidden'
      : 'auto';
  }, [showTimeModal]);
  const toggleModal = () => {
      ...
      >
        ...
        >
          ...
          >
            ...
            <p>
              Your cafe is a place where flavors
              and aromas meet, where warmth and
              comfort abound. It’s a place where
              every guest can savor exquisite
              dishes, prepared with love and skill
              by our chefs. The cafe’s interior is
              designed in a modern style, creating
              an atmosphere of comfort and
              relaxation. Here, you can hold a
              business meeting, celebrate a
              birthday, or simply spend time with
              friends over a cup of coffee. We
              value each of our guests and do
            ...
            <p>
              ...
              our dishes. We also offer a wide
              range of beverages, including
              aromatic coffee, tea, freshly
              squeezed juices, and wine.
            </p>
            <p>
              Additionally, we provide free Wi-Fi,
              so you can work or simply relax
              while browsing the internet. Our
              friendly staff is always ready to
              assist you and answer any questions
              you may have. We look forward to
              welcoming you to our cafe! In our
              cafe, we offer a diverse menu that
              includes local and international
              cuisine. Our chef carefully selects
              only the freshest and highest
              quality ingredients for our dishes.
              We also offer a wide range of
              beverages, including aromatic
              coffee, tea, freshly squeezed
              juices, and wine.
            </p>
          </div>
          <div
